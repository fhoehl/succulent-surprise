...
class Order(models.Model):
    ...
    from_phone = models.CharField('Sender phone', max_length=100)
    ...
    delivery_company_name = models.CharField('Company name', max_length=60)
    delivery_first = models.CharField('Address line 1', max_length=100)
    delivery_second = models.CharField('Address line 2', max_length=100)
    delivery_third = models.CharField('Address line 3', max_length=100)
    delivery_postcode = models.CharField('Postcode', max_length=10)
    delivery_note = models.CharField('Gift note', max_length=200)
